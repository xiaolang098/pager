...
/**
 * 【极客】打印调试信息
 * $Id: inc_debug.php 27 2010-09-25 11:33:10Z wukai$
 */
...
if(SQL_BUG) {
    ...
    <style>
    .tclass, .tclass2 {
    text-align:left;width:995px;border:0;border-collapse:collapse;margin-bottom:5px;table-layout: fixed; word-wrap: break-word;background:#FFF;}
    ...
    <div id="uchome_debug" style="display:;padding-left:177px;">
EOF;
    $class = 'tclass2';
